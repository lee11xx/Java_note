...
//            httpProfile.setReqMethod("POST"); // 默认使用POST
            ...
            req.setSmsSdkAppId("1400782370");   // 短信应用ID: 短信SdkAppId在 [短信控制台] 添加应用后生成的实际SdkAppId
            req.setSignName("李狗子的奇妙代码之旅");         // 签名
            req.setTemplateId("1647886");       // 模板id：必须填写已审核通过的模板 ID。模板ID可登录 [短信控制台] 查看
